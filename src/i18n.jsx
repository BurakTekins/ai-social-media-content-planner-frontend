...
const EN = {
  ...
  'Sağlayıcı': 'Provider', 'Sağlayıcı seçin': 'Select provider', 'Model seçin': 'Select model', 'Model ID': 'Model ID', 'Platform': 'Platform', 'Format': 'Format', 'Durum': 'Status',
  ...
  'Yayın denemeleri yükleniyor': 'Loading publication attempts', 'Yayın denemesi yok': 'No publication attempts', "İçerik yayın job'u tarafından işlendiğinde denemeler burada görünecek.": 'Attempts will appear here after the publication job processes the content.', 'Başarılı': 'Successful',
  'Yayın geçmişi': 'Publication history', 'Düzenle': 'Edit', 'İçerik metni': 'Content text', "Hashtag'ler": 'Hashtags', 'Boşluk, virgül veya satır ile ayırın': 'Separate with spaces, commas, or lines', 'Vazgeç': 'Cancel', 'Kaydet': 'Save', 'Medya': 'Media', 'Sil': 'Delete', 'Yükleniyor…': 'Uploading…', 'Değiştir': 'Replace', 'Yükle': 'Upload', 'Henüz planlanmadı': 'Not scheduled yet', 'Planı iptal et': 'Cancel schedule', 'Taslağı sil': 'Delete draft', 'Yayın zamanı': 'Publication time',
  'Taslak yönetimi': 'Draft management', 'İçerik kütüphanesi': 'Content library', 'Üretilen içerikleri düzenleyin, medyalarını yönetin ve yayın akışına alın.': 'Edit generated content, manage media, and move it into the publication flow.', 'Bu sayfadaki kayıt': 'Records on this page', 'Batch UUID ile filtrele': 'Filter by batch UUID', 'Uygula': 'Apply', 'İçerikler yükleniyor': 'Loading contents', 'İçerik bulunamadı': 'No content found', 'Filtreleri temizleyin veya üretim ekranından yeni bir batch başlatın.': 'Clear the filters or start a new batch from the generation screen.', 'Üretime git': 'Go to generation', 'İçerik detayı': 'Content details', 'İçerik yükleniyor': 'Loading content', 'İçerik detayı yükleniyor': 'Loading content details',
  ...
  'Güvenlik:': 'Security:', 'API anahtarları ve erişim belirteçleri kaydedildikten sonra arayüzde gösterilmez. Burada yalnızca bağlantı ve doğrulama durumunu görürsünüz.': 'API keys and access tokens are not shown after they are saved. Only connection and verification status is displayed here.',
  ...
  'İçerik yayınlama işlemi başladığında denemeler burada görünür.': 'Attempts appear here when the publishing process starts.', 'Geçerli bir üretim kimliği girin.': 'Enter a valid generation ID.', 'Üretim kimliğiyle filtrele': 'Filter by generation ID', 'Filtreleri temizleyin veya üretim ekranından yeni bir toplu üretim başlatın.': 'Clear the filters or start a new batch generation from the generation screen.',
